...
const MainContainer = styled.div`
  background-image: url('/public/static/images/header-4.png');
  ...
  @media (max-width: 1016px) {
    background-image: url('/public/static/images/header-3.png');
    background-position: top;
    background-repeat: repeat-x;
    background-size: 100% auto;
    width: 100%;
  ...
  @media (max-width: 765px) {
    background-image: url('/public/static/images/header-2.png');
    background-position: top;
    background-repeat: repeat-x;
    background-size: 100% auto;
  }
  @media (max-width: 507px) {
    background-image: url('/public/static/images/header-1.png');
    background-position: top;
    background-repeat: repeat-x;
    background-size: 100% auto;
  }
